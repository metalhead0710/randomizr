                ...
                <table id="product-table" class="table table-hover">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li class="dropdown-item evil">
                                            <a href="#delete-modal" data-toggle='modal' title="Видалити" data-link="{{ route('files.delete', ['id' => $file->id]) }}" class="delete-file" >
                    ...
                    <tr>
                        <td colspan="4" class="text-center">
                            {{ $files->render('layouts._partials.pagination') }}
                        </td>
                    </tr>
                    </tfoot>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header borderless">
                    <h4 class="modal-title">{{ __('Delete file?') }}</h4>
